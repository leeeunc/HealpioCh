...
--class 테이블 데이터
INSERT INTO CLASS VALUES ('C' || LPAD(SEQ_CLASS.NEXTVAL, 6, '0'), 'M000003','E000002', '요가 수업', '기본적인 요가 동작을 배웁니다', '초급 요가', SYSDATE, '선생님에 대한 소개', 20, '무료', '토,일', '14:00,15:00,16:00,17:00,18:00');
INSERT INTO class VALUES ('C' || LPAD(SEQ_CLASS.NEXTVAL, 6, '0'), 'M000003','E000003', '필라테스 수업', '필라테스 운동을 배웁니다', '초급 필라테스', SYSDATE, '선생님에 대한 소개', 15, '1만원','화,수,목,일', '08:00,09:00,10:00,11:00,13:00,14:00,15:00,16:00,17:00,18:00');
INSERT INTO class VALUES ('C' || LPAD(SEQ_CLASS.NEXTVAL, 6, '0'), 'M000006','E000004', '명상 수업', '명상하는 방법을 배웁니다', '초보자를 위한 명상', SYSDATE, '선생님에 대한 소개', 10, '1.5만원','화,수,목,토', '08:00,09:00,10:00,11:00,13:00,14:00,15:00,16:00,17:00,18:00');
INSERT INTO class VALUES ('C' || LPAD(SEQ_CLASS.NEXTVAL, 6, '0'), 'M000006','E000006', '축구 수업', '월클이 가르치는 슛자세', '초보자를 위한 축구', SYSDATE, '선생님에 대한 소개', 10, '1.5만원','화,수,목', '08:00,09:00,10:00,11:00,13:00,14:00,15:00,16:00,17:00,18:00');
INSERT INTO CLASS VALUES ('C' || LPAD(SEQ_CLASS.NEXTVAL, 6, '0'), 'M000007','E000010', '크로스핏', '즐급게 운동합시다.', '크로스핏', SYSDATE, '선생님에 대한 소개', 20, '무료', '화,목,금', '08:00,09:00,10:00,17:00,18:00');
...
INSERT INTO location VALUES ('L' || LPAD(SEQ_LOCATION.NEXTVAL, 6, '0'), 'C000003', '경기도', '고양시 일산동구', '마두1동');
INSERT INTO location VALUES ('L' || LPAD(SEQ_LOCATION.NEXTVAL, 6, '0'), 'C000004', '서울특별시', '마포구', '대흥동');
